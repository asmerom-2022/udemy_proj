  ...
  Widget build(BuildContext context) {
    TextStyle? getTextStyle(String? type) {
      switch (styleName) {
        ...
        case 'headline3':
          return Theme.of(context).textTheme.bodyLarge?.merge(customStyle);
        case 'headline4':
          return Theme.of(context).textTheme.headlineSmall?.merge(customStyle);
        case 'headline5':
          return Theme.of(context).textTheme.headlineMedium?.merge(customStyle);
        case 'headline6':
          return Theme.of(context).textTheme.headlineLarge?.merge(customStyle);
        case 'subtitle1':
          return Theme.of(context).textTheme.labelSmall?.merge(customStyle);
        case 'subtitle2':
          return Theme.of(context).textTheme.labelMedium?.merge(customStyle);
        case 'caption':
          return Theme.of(context).textTheme.labelMedium?.merge(customStyle);
        case 'bodyText1':
          return Theme.of(context).textTheme.displaySmall?.merge(customStyle);
        case 'bodyText2':
          return Theme.of(context).textTheme.displayMedium?.merge(customStyle);
        case 'bodySmall':
          return Theme.of(context).textTheme.bodySmall?.merge(customStyle);
        case 'bodyMedium':
          return Theme.of(context).textTheme.bodyMedium?.merge(customStyle);
